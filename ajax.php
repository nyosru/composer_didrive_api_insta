...
$dom = HtmlDomParser::file_get_html('https://m.facebook.com/razvedkabar/');
...
//    \f\pa($list1,2,null,'$list1 список связей точек продаж из бд');
...
//    }
//    \f\pa($links_sp_and_sp_serv,2,null,'$links_sp_and_sp_serv список связей точек продаж из бд');
//
//
//
//    $data_in_db = [];
...
//
//                // если нет такого
//                if ( !empty( $date ) && isset($links_sp_and_sp_serv[$sp]) && !empty( $otd ) && !empty( $time ) && !isset($data_in_db[$date . '--' . $sp . '--' . $otd])) {
//
//                    $in2 = array(
//                        'date' => $date,
//                        'sp_on_serv' => $sp,
//                        'sale_point' => isset($links_sp_and_sp_serv[$sp]) ? $links_sp_and_sp_serv[$sp] : '' ,
//                        'otdel' => $otd,
//                        'minut' => $time
//                    );
//
...
//    }
//
//    \f\pa($in3,2,null,'что пишем в базу данных');
